...
What exists today is Home, the `Pair` and `Restore` flows, and every first-party app but Locker: Photos (library, shelves, viewer, editor, places, people and face review, duplicates, memories, collections, search and the album picker — [docs/photos/](docs/photos/README.md#the-apps-screens-and-where-v0s-fourteen-routes-went)); Agenda — home, event and editor ([#1046](https://github.com/srikanth235/centraid/issues/1046)); and Tasks, People, Docs, Notes and Tally in full ([#1047](https://github.com/srikanth235/centraid/issues/1047)). Locker is not on the phone until its unlock model is ruled ([docs/decisions.md](docs/decisions.md#the-app-ports-and-the-shell-kit-1047)); the device hand-offs are tracked in [docs/release/v1-handoffs.md](docs/release/v1-handoffs.md).
