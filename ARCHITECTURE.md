...
What exists today is the navigation model, the screen machines, Home, the Tally list, the Photos grid, the Notes editor, and the `Pair` and `Restore` flows; the rest of the mobile screen surface is unbuilt and tracked in [docs/release/v1-handoffs.md](docs/release/v1-handoffs.md).
