...
Top-level `packages/*` / `apps/*` / `tools/*` source trees and the co-located executable
...
A new package under `packages/foo/src`, a tool under `tools/foo/src`, or executable code added to either
