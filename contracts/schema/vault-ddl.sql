...
-- index idx_blob_staging_held_by_intent on blob_staging
...
-- index idx_enrich_target_failure_declined on enrich_target_failure
CREATE INDEX idx_enrich_target_failure_declined
  ON enrich_target_failure(capability, declined);

-- index idx_enrich_target_failure_target on enrich_target_failure
...
-- table enrich_target_failure on enrich_target_failure
