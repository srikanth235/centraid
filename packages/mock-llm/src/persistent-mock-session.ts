 ...
 * same runtime (the issue's central goal). The implementation lives in the
 * dependency-light `@centraid/mock-llm` package so automation, agent-runtime,
 * gateway tests, and app-engine tests can share it without importing one
 * another's internals.
 */
