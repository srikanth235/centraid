  ...
  describe(DevicesCard, () => {
    it('renders an empty state when no devices are paired', async () => {
      const el = await mount({
        loadDevices: vi.fn<DevicesCardProps['loadDevices']>().mockResolvedValue([]),
      });
    ...
    it('groups devices under the person they act as, in ownership words', async () => {
      const el = await mount({
        ...
        loadMembers: vi.fn<NonNullable<DevicesCardProps['loadMembers']>>().mockResolvedValue([
          member({
    ...
    it('offers the two removal verbs as distinct affordances', async () => {
      const el = await mount({
        loadDevices: vi.fn<DevicesCardProps['loadDevices']>().mockResolvedValue([device()]),
        loadMembers: vi
