...
const deleteApp = vi.fn<typeof import('../../../gateway-client.js').deleteApp>();
const deleteAutomation = vi.fn<typeof import('../../../gateway-client.js').deleteAutomation>();
const runAutomationNow = vi.fn<typeof import('../../../gateway-client.js').runAutomationNow>();
const updateAppMeta = vi.fn<typeof import('../../../gateway-client.js').updateAppMeta>();
const renameInstalledApp = vi.fn<typeof import('../../../gateway-client.js').renameInstalledApp>();
...
const refreshApps = vi.fn<HomeRouteProps['refreshApps']>().mockResolvedValue(undefined);
...
describe('HomeRoute', () => {
  ...
  describe('HomeRoute installed-app context menu', () => {
    it('a bundled install shows Open / App info / Rename / Star / Uninstall — no Delete, Share, or Reveal', async () => {
      ...
      expect(labels).toStrictEqual(['Open', 'App info', 'Rename', 'Star', 'Uninstall']);
