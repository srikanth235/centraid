...
const api = vi.hoisted(() => ({
  ...
  readGatewayCapabilities:
    vi.fn<typeof import('../../../gateway-client.js').readGatewayCapabilities>(),
  ...
  streamAutomationConversationTurn:
    vi.fn<typeof import('../../../gateway-client.js').streamAutomationConversationTurn>(),
  streamAutomationTurn: vi.fn<typeof import('../../../gateway-client.js').streamAutomationTurn>(),
}));
const helpers = vi.hoisted(() => ({
  automationLiveMessages:
    vi.fn<typeof import('./automationLiveMessages.js').automationLiveMessages>(),
  automationTurnMessages:
    vi.fn<typeof import('./automationTurnMessages.js').automationTurnMessages>(),
  createLiveTrace: vi.fn<typeof import('./automationLiveMessages.js').createAutomationLiveTrace>(),
  createLiveTraceFromItems:
    vi.fn<typeof import('./automationLiveMessages.js').createAutomationLiveTraceFromItems>(),
  ...
  finishLiveItem: vi.fn<typeof import('./automationLiveMessages.js').finishAutomationLiveItem>(),
  finishLiveTrace: vi.fn<typeof import('./automationLiveMessages.js').finishAutomationLiveTrace>(),
  loadThread: vi.fn<typeof import('./automationThreadData.js').loadAutomationThreadData>(),
  ...
  reduceItem: vi.fn<typeof import('./automationLiveMessages.js').reduceAutomationItemEvent>(),
  reduceTurn: vi.fn<typeof import('./automationLiveMessages.js').reduceAutomationTurnEvent>(),
  startLiveItem: vi.fn<typeof import('./automationLiveMessages.js').startAutomationLiveItem>(),
}));
...
vi.mock(import('../../screens/AutomationThreadScreen.js') as Promise<unknown>, () => ({
...
vi.mock(import('./automationTurnMessages.js') as Promise<unknown>, async (importOriginal) => ({
...
describe('AutomationViewRoute suite', () => {
  beforeEach(() => {
    ...
    api.streamAutomationTurn.mockReset().mockImplementation(async (_turnId, onEvent, _signal) => {
      onEvent({
        type: 'item.start',
        itemId: 'tool-1',
        ordinal: 1,
    ...
    helpers.createLiveTrace.mockReset().mockReturnValue({ message: 'new', items: new Map() });
    ...
    helpers.finishLiveTrace.mockReset().mockReturnValue({ message: 'finished', items: new Map() });
    ...
    helpers.reduceItem.mockReset().mockReturnValue({ message: 'delta', items: new Map() });
    helpers.reduceTurn.mockReset().mockReturnValue({ message: 'conversation', items: new Map() });
    helpers.startLiveItem.mockReset().mockReturnValue({ message: 'started', items: new Map() });
