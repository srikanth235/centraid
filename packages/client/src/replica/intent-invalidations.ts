...
// (packages/design/kit/intent-invalidations.js, issue #420) so the kit's
...
import { replicaIntentInvalidations as kitReplicaIntentInvalidations } from "@centraid/design/kit/intent-invalidations.js";
