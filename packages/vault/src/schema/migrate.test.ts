...
describe("schema/migrate", () => {
  ...
  test("NINE rungs: the baseline, #929's three, #928's ask tables, #996's key plane and unlock-credential drop, #1014's floor split and its transient holds, and a fresh vault stops at user_version 9", () => {
