...
> = {
  ...
  "health.workout": {
    name: "Workouts",
    blurb: "Exercise sessions you've logged.",
  },
  "health.sleep_session": {
    name: "Sleep",
    blurb: "Nights of sleep you've tracked.",
  },
  "health.medication_course": {
    name: "Medications",
  ...
  "finance.fx_rate": {
    name: "Exchange rates",
    blurb: "Currency conversion rates.",
  },
  // schedule
  "schedule.calendar": {
    name: "Calendars",
  ...
  "home.asset_item": {
    name: "Belongings",
    blurb: "Things you own around the home.",
  },
  "home.warranty": {
    name: "Warranties",
    blurb: "Coverage on the things you own.",
  },
  "home.maintenance_plan": {
    name: "Maintenance",
    blurb: "Upkeep schedules for your things.",
  },
  "home.utility_meter": { name: "Meters", blurb: "Your utility meters." },
  "home.meter_reading": {
    name: "Meter readings",
    blurb: "Readings taken from your meters.",
  },
  // business
  "business.client": {
    name: "Clients",
    blurb: "People and companies you work for.",
  },
  "business.project": {
    name: "Projects",
    blurb: "Work you're doing for clients.",
  },
  "business.time_entry": {
    name: "Time entries",
    blurb: "Hours you've logged on work.",
  },
  "business.invoice": {
    name: "Invoices",
    blurb: "Bills you've sent to clients.",
  },
  "business.invoice_line": {
    name: "Invoice lines",
    blurb: "The line items on an invoice.",
  },
  // people
  "people.profile": {
    name: "Profiles",
