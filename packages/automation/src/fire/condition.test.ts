...
/*
 * The cursor-source readers. Unlike the legacy `evaluate*` pair these hold no
 * state of their own: the engine hands them the committed position and commits
 * whatever they return — so what they return may never run ahead of what they
 * delivered.
 */
