...
const moduleUrl = pathToFileURL(path.resolve(import.meta.dirname, '../apps/photos/scopes.ts')).href;
...
function mount(scopes: Scope[] | undefined, { readAll = true }: { readAll?: boolean } = {}): void {
