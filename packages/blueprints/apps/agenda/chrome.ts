...
// purely to keep app.tsx under the file-size cap, same shape as tasks/notes'
// chrome.ts.
import { observeWidth, onFocusRefresh, wireThemeToggle } from './kit.js';
import type { AppState, ViewKind } from './types.ts';
...
export function wireChrome({
  ...
  // layout, same convention as tasks/notes' chrome.ts. A ResizeObserver
