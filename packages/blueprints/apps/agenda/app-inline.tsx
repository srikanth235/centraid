...
// Agenda, inline (issue #505). The served entry (app.tsx) stays byte-for-byte
...
// `logic.ts` (vault IO, calendar coloring, activity log, parked tracking,
// search), `format.ts` (date/range/bucketing), `pending.ts` and every
// `components/*` are reused verbatim; `chrome.ts`'s imperative listeners become
// hooks + JSX handlers; app.tsx's six `createRoot` islands + imperative
