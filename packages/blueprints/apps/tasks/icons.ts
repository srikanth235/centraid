...
// of the icon map being re-declared or threaded as props. Left un-annotated so
// each member infers as a string literal key (`I.check` is `string`, not the
// `string | undefined` an index signature would give under
