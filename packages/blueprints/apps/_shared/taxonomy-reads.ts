 ...
 *
 * Six query handlers across Docs and People open the same way: read every
 * `core.concept`, read every `core.concept_scheme`, and hand both to
 ...
 * which is the honest reading — a bound restated in six files is six places to
 * forget when the window changes.
 *
