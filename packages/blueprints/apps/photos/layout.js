...
// header comment for why. `layout.js` doesn't use this for CSS (that's a
...
// the caller (a ResizeObserver in app.jsx) — the accurate source of truth.
 ...
 */
export function justify(list, containerWidth, targetHeight) {
  const rows = [];
  let row = [];
  let sum = 0;
