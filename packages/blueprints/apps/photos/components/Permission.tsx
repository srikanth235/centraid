...
//
// NEVER A `kit-banner` STRIP at the head of the pane. A strip says "something
// went wrong up there"; an ungranted or revoked grant is not a fault, it is a
// state the product is designed for — so it takes the whole pane, in the app's
// own register: a display-serif headline, one paragraph in the reading
// register, what is missing, and the two facts a member actually wants (what
// Photos can see meanwhile, and what happens if the grant comes back).
//
...
// re-read immediately (packages/design/src/elements/refresh.ts).
//
