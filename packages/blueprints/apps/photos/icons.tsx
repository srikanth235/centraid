...
export const CameraIcon: FC<IconProps> = (p) => (
  <Svg {...p}>
...
export const AlbumsIcon: FC<IconProps> = (p) => (
  <Svg {...p}>
...
export const DuplicatesIcon: FC<IconProps> = (p) => (
  <Svg {...p}>
...
export const ZoomOutIcon: FC<IconProps> = (p) => (
  <Svg {...p}>
...
export const ZoomInIcon: FC<IconProps> = (p) => (
  <Svg {...p}>
...
export const RenameIcon: FC<IconProps> = (p) => (
  <Svg {...p} size={14}>
    <path d="M12 20h9" />
    <path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z" />
  </Svg>
