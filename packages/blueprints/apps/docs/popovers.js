...
// with kit's h()/popItem(), exactly as logic.js always built them inline.
// Split out purely to keep logic.js under the file-size cap (same factory
// pattern as versions.js): closes over data.folders (read-only) plus the
// document-write functions logic.js already owns, passed in rather than
// re-implemented here.
