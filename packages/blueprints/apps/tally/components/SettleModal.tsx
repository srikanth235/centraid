...
export function SettleModal({
  ...
  me: string | null;
  currency: string;
  personOf: (pid: string) => Person;
  onPatch: (patch: Partial<SettleModel>) => void;
  onClose: () => void;
  onSave: () => void;
}) {
      ...
      <div className="kit-modal" style={{ maxWidth: '420px' }} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={shared.row2}>
          <div className={shared.field} style={{ flex: 1 }}>
            <div className={shared.flabel}>From</div>
            <SettleSelect
              people={st.people}
              value={st.from}
              me={me}
          ...
          <div className={shared.field} style={{ flex: 1 }}>
            <div className={shared.flabel}>To</div>
            <SettleSelect
              people={st.people}
              value={st.to}
              me={me}
        ...
        <div className={shared.field}>
          <div className={shared.flabel}>Amount</div>
