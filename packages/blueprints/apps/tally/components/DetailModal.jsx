...
import { ArmedButton, ModalBackdrop } from './Shared.jsx';

export function DetailModal({ row, me, groups, currency, onClose, onEdit, onDelete }) {
      ...
      <div className="kit-modal" style={{ maxWidth: '440px' }} onClick={(e) => e.stopPropagation()}>
        ...
        <div>
          {(row.splits ?? []).map((s) => (
            ...
            >
              <kit-avatar name={s.name} size="28px" color={s.color} initials={s.initials} />
