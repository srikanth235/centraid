...
// function is a plain projection of its arguments so app.jsx and the
...
export function checkStats(body) {
...
export function deriveTitle(title, body) {
...
export function notebookColorVar(notebookId) {
