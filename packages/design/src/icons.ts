...
const ICON_DATA = {
  ...
  // Own entry, not `Archive`: an inbox holds work that has ARRIVED and is
  // undecided, an archive holds work put away. Tasks' band names both, so one
  // glyph for the two would make the destinations indistinguishable.
  Inbox: [
