 ...
 *     optional `invokeDispatcher`. runtime-core doesn't know how to
...
export interface RunAutomationHandlerOptions {
  /** Id of the automation project (its directory name). */
  automationId: string;
  /** The automation project directory — handler logs are written here. */
