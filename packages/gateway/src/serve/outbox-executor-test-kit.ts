...
export function configureApiKey(plane: VaultPlane, over: Record<string, unknown> = {}): string {
...
export function stageItem(plane: VaultPlane, over: Record<string, unknown> = {}): string {
  const outcome = plane.gateway.invoke(plane.ownerCredential, {
...
export function itemRow(plane: VaultPlane, itemId: string): Record<string, unknown> {
