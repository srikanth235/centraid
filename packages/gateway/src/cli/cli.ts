...
function usage(): never {
  process.stderr.write(
    [
      ...
      '  centraid-gateway pair --data-dir <path> [--vault <name-or-id>] [--ttl-minutes <n>] [--trust owner|full|readonly] [--json]',
      ...
      'overrides. A ticket minted by `pair` also redeems over plain HTTP (POST',
