/**
 * Shared outbound-fetch timeout (#351 Tier 4 hygiene) for the two
 ...
 * outbox executor's external writes (`outbox-executor.ts`). Unbounded, a hung
 * IdP token endpoint or a hung third-party write endpoint wedges the caller
 * (a fire, a drain pass) indefinitely.
 *
