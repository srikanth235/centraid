...
export interface TemplatesRouteOptions {
  /**
   * Per-gateway template cache dir. When present, a newer per-template copy
   * under it shadows the bundled one; omit for bundle-only resolution (the
   * standalone daemon / tests).
   */
  cacheDir?: string;
