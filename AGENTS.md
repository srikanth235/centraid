...
- **Vocabulary**: **the phone is the vault** and the laptop is a *gateway*, never a server or a host. A *drain* is a pass that uploads the spool; a *generation* is a base plus its segments. The conversation/turn/item ledger is **gone** — its tables were dropped in rung five (#1029 W19) and nothing writes it.
