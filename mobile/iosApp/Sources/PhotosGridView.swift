...
struct PhotosGridView: View {
    ...
    var body: some View {
        ...
        // band row, "Camera roll backup is off." and "Back up now" all drew
        ...
        // THE HORIZONTAL MARGIN STAYS ON THE SCREEN, ONCE (R-PHOTOS-2). It is
        // outside the scroll view so the page margin does not scroll with the
        // grid, and `BackupStatus` still carries none of its own.
