// Stub-tier tests own props, pure output, rendered strings and serialized styles
// (#890 W5); they cannot prove RN accessibility promotion, responder refusal,
// native layout, or list virtualization. Those claims belong to RNTL/Maestro.
