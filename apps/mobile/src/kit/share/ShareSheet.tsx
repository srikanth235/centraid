...
/** The three answers a role control gives, in the order the menu offers them.
 *  `undefined` is "no access" — the absence of a selection, not a third
 *  capability the wire knows about. */
...
export default function ShareSheet({
  ...
  // A person the member is looking for stays findable while the sheet fills
  // up: the roster is a vault's worth of people, not a handful.
