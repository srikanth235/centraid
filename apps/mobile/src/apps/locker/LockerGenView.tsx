...
export default function LockerGenView(
  ...
  // The screen arrives with a string on it — a generator that opened empty
  // would make the first act "press the button that makes the thing you came
  // for". Regenerating on an option change is the same reasoning.
  useEffect(() => {
