...
export default function PhotosAskView({
  navigation,
}: {
  navigation: Nav;
}): React.JSX.Element {
  ...
  return (
    <View style={styles.root}>
      ...
      >
        <View style={styles.empty}>
          ...
          <Text style={[styles.subcopy, { color: colors.ink3 }]}>
            Ask in your own words. Centraid searches faces, places, text and
            moments across your vault — privately, on your device.
          </Text>
        </View>
      ...
      >
        ...
        >
          <Text style={[styles.inputText, { color: colors.ink3 }]}>
