// Agenda's event screen — deliberately EMPTY pending a ground-up redesign.
//
// The screen was removed wholesale rather than migrated: the next one is drawn
...
export default function AgendaEvent(
  _props: AgendaScreenProps<"AgendaEvent">
): React.JSX.Element {
