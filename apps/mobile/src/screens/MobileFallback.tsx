    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.body}>
        ...
        <View style={styles.steps}>
          <Step num="1" text="Open Centraid on your computer." />
          <Step num="2" text='Tap "New app" and describe what you want.' />
          <Step num="3" text="It'll show up on this home screen." />
        </View>
...
function Step({ num, text }: StepProps): React.JSX.Element {
  return (
