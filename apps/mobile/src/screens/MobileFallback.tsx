    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.body}>
        ...
        <Text style={styles.copy}>
          Centraid's builder is a chat-driven canvas — designed for a keyboard
          and a wider screen. Open Centraid on your Mac to describe a new app
          and watch it appear.
        </Text>
        ...
        <View style={styles.steps}>
          <Step
            num="1"
            text="Open Centraid on your computer."
            styles={styles}
          />
          <Step
            num="2"
            text='Tap "New app" and describe what you want.'
            styles={styles}
          />
          <Step
            num="3"
            text="It'll show up on this home screen."
            styles={styles}
          />
        </View>
