    ...
    >
        ...
        {paired ? (
          ...
          <View>
            <Text style={styles.help}>
              ...
              <Text style={styles.helpMono}>centraid-gateway pair --qr</Text> on
              a VPS. You can also paste the one-line ticket. Apps then load over
              an encrypted tunnel.
            </Text>
            {tunnelAvailable ? (
              <>
      ...
      <SettingsSection label="Storage">
        ...
        >
          ...
          <Text style={styles.rowLabel}>Backup health and transfer rules</Text>
          <Icon name="ChevronRight" size={16} color={colors.textFaint} />
        </Pressable>
      </SettingsSection>
