/* eslint-disable -- generated by Wrangler; tracked in #526 */
// governance: allow-repo-hygiene file-size-limit #526 Wrangler-generated runtime declarations are indivisible.
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 76f5f55f20bb947e8a57614f9de8e208)
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      Cloudflare.Env,
      'APP_ORIGIN' | 'CALLBACK_URL' | 'EXCHANGE_ENABLED' | 'RESTRICTED_SCOPES_ENABLED'
    >
  > {}
}
...
***************************************************************************** */
/* eslint-disable -- generated workerd declarations; tracked in #526 */
...
declare abstract class ReadableStreamDefaultController<R = any> {
  ...
  close(): void;
  /**
   * The **`enqueue()`** method of the ```js-nolint enqueue(chunk) ``` - `chunk` - : The chunk to enqueue. #526
   *
...
declare class URL {
  ...
  /**
   * The **`toJSON()`** method of the URL interface returns a string containing a serialized version of the URL, although in practice it seems to have the same effect as ```js-nolint toJSON() ``` None. #526
   *
...
declare class EventSource extends EventTarget {
  ...
  /**
   * The **`close()`** method of the EventSource interface closes the connection, if one is made, and sets the ```js-nolint close() ``` None. #526
   *
...
type AIGatewayUniversalRequest = {
  provider: AIGatewayProviders | string; // eslint-disable-line -- generated; #526
  endpoint: string;
...
declare abstract class AiGateway {
  ...
  getUrl(provider?: AIGatewayProviders | string): Promise<string>; // eslint-disable-line -- generated; #526
}
