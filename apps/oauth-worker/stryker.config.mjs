...
export default {
  ...
  // reads, HTML pages, WebCrypto HMAC). Lines 834–914 are the pure predicate
  ...
  // `escapeHtml` (916–938). They are pure too, but their inputs are not
  ...
  // can kill.
  //
  // The range is line-addressed, so `worker-guards.test.ts` asserts that
