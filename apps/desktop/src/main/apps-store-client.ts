...
import type { ListAutomationAppsResult } from '@centraid/automation';
...
// ---- Automation read (issue #141) ----
// The run/analytics surface (read/run-now/runs/run/nodes/pin + insights)
// moved to the renderer's direct HTTP client (renderer/gateway-client.ts)
// under the thin-client pivot. Only `listAutomationsHttp` stays here — the
