...
// heartbeat monitor. Data arrives as pushed snapshots (useGatewayRuntime);
// the only writes are the down-alert settings, saved through the standard
// settings surface (main clamps + re-broadcasts immediately, so the screen
// reflects the change on the next pushed snapshot). A 1s local ticker
// drives the running counters (gateway uptime, "for 2h 14m") between polls.
