 ...
 * gateway tunnel.
 */
export function connect_failure_marker(): string;
 ...
 */
export function device_revoked_marker(): string;
...
export interface InitOutput {
  ...
  readonly connect_failure_marker: (a: number) => void;
  readonly device_revoked_marker: (a: number) => void;
  readonly start: () => void;
  ...
  readonly __wasm_bindgen_func_elem_2043: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_6258: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_5039: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_4346: (a: number, b: number, c: number, d: number) => void;
  readonly __wasm_bindgen_func_elem_2044: (a: number, b: number, c: number) => void;
