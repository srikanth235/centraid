/* @ts-self-types="./centraid_web_iroh.d.ts" */
...
export class BrowserEndpoint {
  ...
  __destroy_into_raw() {
    ...
    this.__wbg_ptr = 0;
    BrowserEndpointFinalization.unregister(this);
    return ptr;
  }
  free() {
    const ptr = this.__destroy_into_raw();
    wasm.__wbg_browserendpoint_free(ptr, 0);
  }
  /**
   * @returns {Promise<void>}
   */
  close() {
    const ret = wasm.browserendpoint_close(this.__wbg_ptr);
  ...
  /**
   * @param {string} endpoint_ticket
   * @param {string} request_json
   * @returns {Promise<string>}
   */
  pair_gateway(endpoint_ticket, request_json) {
    ...
    const ret = wasm.browserendpoint_pair_gateway(this.__wbg_ptr, ptr0, len0, ptr1, len1);
    return takeObject(ret);
  }
  /**
   * @param {string} endpoint_ticket
   ...
   */
  request(endpoint_ticket, method, target, headers_json, body) {
    const ptr0 = passStringToWasm0(
      endpoint_ticket,
      wasm.__wbindgen_export,
      wasm.__wbindgen_export2,
    ...
    const ptr3 = passStringToWasm0(headers_json, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len3 = WASM_VECTOR_LEN;
    const ptr4 = passArray8ToWasm0(body, wasm.__wbindgen_export);
    const len4 = WASM_VECTOR_LEN;
    const ret = wasm.browserendpoint_request(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
   ...
   * @param {string[] | null} [relay_urls]
   * @returns {Promise<BrowserEndpoint>}
   */
  static spawn(secret_key, relay_urls) {
    var ptr0 = isLikeNone(secret_key) ? 0 : passArray8ToWasm0(secret_key, wasm.__wbindgen_export);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(relay_urls)
      ? 0
      : passArrayJsValueToWasm0(relay_urls, wasm.__wbindgen_export);
    var len1 = WASM_VECTOR_LEN;
    const ret = wasm.browserendpoint_spawn(ptr0, len0, ptr1, len1);
    return takeObject(ret);
  }
}
if (Symbol.dispose) BrowserEndpoint.prototype[Symbol.dispose] = BrowserEndpoint.prototype.free;
...
export class BrowserResponse {
  ...
  __destroy_into_raw() {
    const ptr = this.__wbg_ptr;
    this.__wbg_ptr = 0;
    BrowserResponseFinalization.unregister(this);
    return ptr;
  }
  free() {
    const ptr = this.__destroy_into_raw();
    wasm.__wbg_browserresponse_free(ptr, 0);
  }
  /**
   * @returns {string}
   */
   ...
   */
  get status() {
    const ret = wasm.browserresponse_status(this.__wbg_ptr);
    return ret;
  }
  /**
...
if (Symbol.dispose) BrowserResponse.prototype[Symbol.dispose] = BrowserResponse.prototype.free;
 ...
 * @returns {string}
 */
export function connect_failure_marker() {
  let deferred1_0;
  let deferred1_1;
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    wasm.connect_failure_marker(retptr);
    var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
    var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    deferred1_0 = r0;
    deferred1_1 = r1;
 ...
 * @returns {string}
 */
export function device_revoked_marker() {
  let deferred1_0;
  let deferred1_1;
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    wasm.device_revoked_marker(retptr);
    var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
    var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    deferred1_0 = r0;
    deferred1_1 = r1;
...
function __wbg_get_imports() {
  const import0 = {
    ...
    __wbg_addEventListener_14e74488d3142fa7: function () {
    ...
    __wbg_browserendpoint_new: function (arg0) {
      const ret = BrowserEndpoint.__wrap(arg0);
      return addHeapObject(ret);
    },
    __wbg_browserresponse_new: function (arg0) {
      const ret = BrowserResponse.__wrap(arg0);
      return addHeapObject(ret);
    },
    ...
    __wbg_clearTimeout_5e42188b495715bb: function () {
      return handleError(function (arg0, arg1) {
    ...
    __wbg_close_1d08eaf57ed325c0: function () {
      return handleError(function (arg0) {
        getObject(arg0).close();
      }, arguments);
    },
    ...
    __wbg_getRandomValues_a8ddca022803a145: function () {
      return handleError(function (arg0, arg1) {
    ...
    __wbg_getReader_f47519d698a4505e: function () {
      return handleError(function (arg0) {
    ...
    __wbg_new_b5d9e2fb389fef91: function (arg0, arg1) {
      try {
        ...
        var cb0 = (arg0, arg1) => {
          ...
          state0.a = 0;
          try {
            return __wasm_bindgen_func_elem_4346(a, state0.b, arg0, arg1);
          } finally {
            state0.a = a;
          }
        };
    ...
    __wbg_new_with_into_underlying_source_abe21fd181832f61: function (arg0, arg1) {
    ...
    __wbg_new_with_str_sequence_b67b3919b8b11238: function () {
      return handleError(function (arg0, arg1, arg2) {
    ...
    __wbg_removeEventListener_34a7e78acf851dd7: function () {
      return handleError(function (arg0, arg1, arg2, arg3) {
    ...
    __wbg_send_542f95dea2df7994: function () {
      return handleError(function (arg0, arg1, arg2) {
    ...
    __wbg_setTimeout_2b111259203a2623: function () {
      return handleError(function (arg0, arg1, arg2) {
    ...
    __wbindgen_cast_0000000000000001: function (arg0, arg1) {
      // Cast intrinsic for `Closure(Closure { dtor_idx: 179, function: Function { arguments: [NamedExternref("CloseEvent")], shim_idx: 180, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
      const ret = makeMutClosure(
        arg0,
        arg1,
        wasm.__wasm_bindgen_func_elem_2043,
        __wasm_bindgen_func_elem_2044,
      );
      return addHeapObject(ret);
    },
    __wbindgen_cast_0000000000000002: function (arg0, arg1) {
      // Cast intrinsic for `Closure(Closure { dtor_idx: 188, function: Function { arguments: [], shim_idx: 177, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
      const ret = makeMutClosure(
        arg0,
        arg1,
        wasm.__wasm_bindgen_func_elem_6258,
        __wasm_bindgen_func_elem_5040,
      );
      return addHeapObject(ret);
    },
    __wbindgen_cast_0000000000000003: function (arg0, arg1) {
      // Cast intrinsic for `Closure(Closure { dtor_idx: 56, function: Function { arguments: [Externref], shim_idx: 180, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
      const ret = makeMutClosure(
        arg0,
        arg1,
        wasm.__wasm_bindgen_func_elem_5039,
        __wasm_bindgen_func_elem_2044,
      );
      return addHeapObject(ret);
    },
    __wbindgen_cast_0000000000000004: function (arg0, arg1) {
      // Cast intrinsic for `Closure(Closure { dtor_idx: 56, function: Function { arguments: [NamedExternref("MessageEvent")], shim_idx: 180, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
      const ret = makeMutClosure(
        arg0,
        arg1,
        wasm.__wasm_bindgen_func_elem_5039,
    ...
    __wbindgen_cast_0000000000000005: function (arg0, arg1) {
      // Cast intrinsic for `Closure(Closure { dtor_idx: 56, function: Function { arguments: [], shim_idx: 177, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
      const ret = makeMutClosure(
        arg0,
        arg1,
        wasm.__wasm_bindgen_func_elem_5039,
  ...
  return {
    __proto__: null,
    './centraid_web_iroh_bg.js': import0,
  };
}

function __wasm_bindgen_func_elem_5040(arg0, arg1) {
  wasm.__wasm_bindgen_func_elem_5040(arg0, arg1);
}
...
function __wasm_bindgen_func_elem_2044(arg0, arg1, arg2) {
  wasm.__wasm_bindgen_func_elem_2044(arg0, arg1, addHeapObject(arg2));
}

function __wasm_bindgen_func_elem_4346(arg0, arg1, arg2, arg3) {
  wasm.__wasm_bindgen_func_elem_4346(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
const BrowserEndpointFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) => wasm.__wbg_browserendpoint_free(ptr >>> 0, 1));
const BrowserResponseFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) => wasm.__wbg_browserresponse_free(ptr >>> 0, 1));
...
function debugString(val) {
  ...
  // Follow-up (issue #462): we could test for more things here, like `Set`s and `Map`s.
  return className;
}
