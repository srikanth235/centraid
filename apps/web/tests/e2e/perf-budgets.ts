...
export const perfBudgets: PerfBudgets = {
  ...
  appOpen: {
    cold: {
      ...
      // simply a bigger interface than Tasks was; nothing here is PDF.js, which
      // stays behind its dynamic import (#676 keeps it that way deliberately —
      // see packages/blueprints/apps/docs/pdf-text.ts).
      //
