...
| **Nightly** | Full cross-client suites, perf budgets, mobile (**isolated iOS journey matrix + Android home-loads**), pairing journeys, scale, **mutation (Stryker)** |
