...
| steer-2d64cff5a78-1780558746-1 | 2d64cff5-a78a-4b08-afe1-35eaef23a9cd | #192 | interrupt | structural |  | feat(agent-runtime): enumerate claude models via SDK supportedModels() (#192) -… |
| steer-2d64cff5a78-1780558746-2 | 2d64cff5-a78a-4b08-afe1-35eaef23a9cd | #192 | interrupt | structural |  | feat(agent-runtime): enumerate claude models via SDK supportedModels() (#192) -… |
| steer-2d64cff5a78-1780558746-3 | 2d64cff5-a78a-4b08-afe1-35eaef23a9cd | #192 | correction | lexical | wait can you check if calude works with just haiku id (without specifying any version) | feat(agent-runtime): enumerate claude models via SDK supportedModels() (#192) -… |
...
| steer-5d76c40b3ca-1780571343-1 | 5d76c40b-3ca7-46ee-8157-75cea189bdaa | #194 | correction | classifier | Questions redundant 'automation' subfolder and prefix in nearly every filename | refactor(automation-engine): flatten src layout, drop automation- filename pref… |
...
| steer-1b64beca379-1780634880-1 | 1b64beca-3790-4a16-9b15-0502da7a48f3 | #216 | correction | classifier | Overrode agent's preferred static seed; chose enumerate-on-boot instead | feat(agent-runtime): boot-warm catalog, drop the model seed, add a loading stat… |
| steer-1b64beca379-1780634880-2 | 1b64beca-3790-4a16-9b15-0502da7a48f3 | #216 | correction | classifier | Rejected keeping the seed; demanded unified tool/model warm + loading state | feat(agent-runtime): boot-warm catalog, drop the model seed, add a loading stat… |
| steer-1b64beca379-1780634880-3 | 1b64beca-3790-4a16-9b15-0502da7a48f3 | #216 | interrupt | structural |  | feat(agent-runtime): boot-warm catalog, drop the model seed, add a loading stat… |
