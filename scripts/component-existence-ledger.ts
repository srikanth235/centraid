...
export const RAW_DIALOG_LEDGER: Readonly<Record<string, number>> =
  Object.freeze({});

/** Class-less `<button>` elements. Kit equivalent: kit Button.
 *  EMPTY since #883 wave 6 — the end state this lane was built for. */
export const UNSTYLED_BUTTON_LEDGER: Readonly<Record<string, number>> =
  Object.freeze({});
...
export const UNSTYLED_PRESSABLE_LEDGER: Readonly<Record<string, number>> =
  Object.freeze({});
