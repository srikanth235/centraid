...
export const MUTATION_SEEDS: MutationSeed[] = [
  {
    ...
    watch: [
      ...
      "packages/vault/stryker.config.ts",
  ...
  },
  {
    ...
    watch: [
      ...
      "packages/client/stryker.config.ts",
  ...
  },
  {
    ...
    label: "automation",
    cwd: "packages/server",
    config: "stryker.automation.config.ts",
    ...
    watch: [
      ...
      "packages/server/stryker.automation.config.ts",
  ...
  },
  {
    ...
    watch: [
      ...
      "packages/backup/stryker.config.ts",
  ...
  },
  {
    ...
    watch: [
      ...
      "packages/core/stryker.blob.config.ts",
  ...
  },
  {
    ...
    label: "protocol",
    cwd: "packages/core",
    config: "stryker.protocol.config.ts",
    ...
    watch: [
      ...
      "packages/core/stryker.protocol.config.ts",
  ...
  },
  {
    ...
    watch: [
      ...
      "packages/tunnel/stryker.config.ts",
  ...
  },
  {
    ...
    label: "app-engine",
    cwd: "packages/server",
    config: "stryker.engine.config.ts",
    ...
    watch: [
      ...
      "packages/server/stryker.engine.config.ts",
  ...
  },
  {
    ...
    watch: [
      ...
      "packages/server/stryker.config.ts",
  ...
  },
  {
    ...
    watch: [
      ...
      "packages/server/stryker.acp.config.ts",
  ...
  // defends (see each package's stryker.config.ts for why those paths, and
  // what was deliberately left out).
  {
    ...
    watch: [
      ...
      "packages/blueprints/stryker.config.ts",
  ...
  },
  {
    ...
    watch: [
      ...
      "packages/core/stryker.time.config.ts",
  ...
  },
  {
    ...
    watch: [
      ...
      "packages/cli/stryker.config.ts",
  ...
  },
  {
    ...
    watch: [
      ...
      "packages/design/stryker.config.ts",
  ...
  },
  {
    ...
    watch: [
      ...
      "apps/oauth-worker/stryker.config.ts",
  ...
  },
  {
    ...
    watch: [
      ...
      "packages/model-runtime/stryker.config.ts",
  ...
  // Each seed's stryker config says what it leaves out and why.
  {
    ...
    label: "tasks",
    cwd: "packages/blueprints",
    config: "stryker.tasks.config.ts",
    ...
    watch: [
      ...
      "packages/blueprints/stryker.tasks.config.ts",
  ...
  },
  {
    ...
    label: "notes",
    cwd: "packages/blueprints",
    config: "stryker.notes.config.ts",
    ...
    watch: [
      ...
      "packages/blueprints/stryker.notes.config.ts",
  ...
  },
  {
    ...
    label: "agenda",
    cwd: "packages/blueprints",
    config: "stryker.agenda.config.ts",
    ...
    watch: [
      ...
      "packages/blueprints/stryker.agenda.config.ts",
  ...
  },
  {
    ...
    cwd: "packages/blueprints",
    config: "stryker.pending-overlay.config.ts",
    ...
    watch: [
      ...
      "packages/blueprints/stryker.pending-overlay.config.ts",
  ...
  },
  {
    ...
    label: "selection",
    cwd: "packages/blueprints",
    config: "stryker.selection.config.ts",
    ...
    watch: [
      ...
      "packages/blueprints/stryker.selection.config.ts",
  ...
  },
  {
    ...
    label: "triage",
    cwd: "packages/blueprints",
    config: "stryker.triage.config.ts",
    ...
    watch: [
      ...
      "packages/blueprints/stryker.triage.config.ts",
  ...
  },
  {
    ...
    cwd: "packages/blueprints",
    config: "stryker.search-scaffold.config.ts",
    ...
    watch: [
      ...
      "packages/blueprints/stryker.search-scaffold.config.ts",
  ...
  // mutates and why.
  {
    ...
    label: "untrusted",
    cwd: "packages/blueprints",
    config: "stryker.untrusted.config.ts",
    ...
    watch: [
      ...
      "packages/blueprints/stryker.untrusted.config.ts",
