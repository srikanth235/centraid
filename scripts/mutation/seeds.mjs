...
export const MUTATION_SEEDS = [
  ...
  {
    id: "packages/design-tokens",
    label: "design-tokens",
    cwd: "packages/design-tokens",
    config: "stryker.config.mjs",
    report: "artifacts/mutation/design-tokens-report.json",
    watch: [
      "packages/design-tokens/src/css.ts",
      "packages/design-tokens/src/typography.ts",
      "packages/design-tokens/src/tile.ts",
      "packages/design-tokens/src/css-properties.test.ts",
      "packages/design-tokens/src/tile-properties.test.ts",
      "packages/design-tokens/stryker.config.mjs",
      "packages/design-tokens/vitest.mutation.config.ts",
    ],
  },
  {
