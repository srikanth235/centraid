 ...
 */
function lockedCrates(name: string, crates: string[]): string {
...
function allRecords(
  outcome: string
): { tool: string; crate: string; outcome: string }[] {
...
function skipRecords(): { tool: string; crate: null; outcome: string }[] {
