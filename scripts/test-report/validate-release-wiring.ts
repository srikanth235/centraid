 ...
 */
function jobBlocks(text: string) {
...
function declaredLaneSecrets(text: string) {
...
function forwardedSecrets(jobBody: unknown) {
 ...
 */
export function lintReleaseWiring(
  root: string | undefined = REPO_ROOT
): string[] {
  const errors: string[] = [];
