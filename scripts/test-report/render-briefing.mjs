...
/** Styles the briefing adds on top of the report's existing sheet. */
export const BRIEFING_CSS = `.verdict{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,360px);gap:24px;align-items:center;padding:20px 22px;margin-bottom:14px;border:1px solid var(--line);border-radius:6px;background:color-mix(in srgb,var(--panel) 94%,transparent);border-left:5px solid var(--grey)}.verdict-shippable{border-left-color:var(--green)}.verdict-degraded{border-left-color:var(--amber)}.verdict-red{border-left-color:var(--red)}.verdict-no-evidence{border-left-color:var(--grey)}.verdict-level{display:block;font-size:clamp(26px,3.4vw,40px);letter-spacing:-.04em;line-height:1.05;margin:4px 0 8px}.verdict-shippable .verdict-level{color:var(--green)}.verdict-degraded .verdict-level{color:var(--amber)}.verdict-red .verdict-level{color:var(--red)}.verdict-no-evidence .verdict-level{color:var(--text-soft)}.chips{display:flex;gap:6px;flex-wrap:wrap;margin:0 0 8px}.chip{display:inline-flex;align-items:center;gap:5px;padding:3px 8px;border:1px solid var(--line);border-radius:99px;font-size:11px;color:var(--text-soft);margin-right:5px}.chip b{color:var(--text)}.delta-worse{border-color:var(--red);color:var(--red)}.delta-better{border-color:var(--green);color:var(--green)}.chip-new{border-color:var(--amber);color:var(--amber)}.chip-pinned{border-color:var(--violet);color:var(--violet)}.band-S1{border-color:var(--red);color:var(--red)}.band-S2{border-color:#ff9e64;color:#ff9e64}.band-S3{border-color:var(--amber);color:var(--amber)}.band-S4{border-color:var(--violet);color:var(--violet)}.queue-row td{vertical-align:top}.metric.pinned{color:var(--violet)}.metric.unowned,.metric.stale{color:var(--text-soft)}.metric.flaky{color:var(--violet)}.metric.skipped{color:var(--amber)}.metric.infra-mismatch{color:var(--red)}.metric.owner-silent,.metric.lane-did-not-run,.metric.evidence-unmatched{color:#ffcb6b}.spark-slot{display:inline-block;min-width:120px;padding:6px 0;color:var(--text-soft);font-size:11px;border-bottom:1px dashed #334038}.adversary-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(320px,1fr));gap:18px}.adversary-grid h3{font-size:13px;margin:0 0 8px;color:var(--text-soft);font-weight:650}@media(max-width:900px){.verdict{grid-template-columns:1fr}}`;
