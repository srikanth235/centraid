<!-- governance: allow-receipt-per-issue (#468) this receipt covers the #468 shipping-surface work, but the commit carrying it is a same-day history-rewrite squash that also folds in the #474 nightly-e2e repair. File coverage therefore sees a change set spanning two issues, which no single receipt can name. Both receipts are present and their #468/#474 content is unchanged; the squash added no code. -->
