...
- **New** `packages/client/src/react/shell/routes/settingsCronTimezoneData.ts` and `packages/client/src/react/shell/routes/settingsCronTimezoneData.test.ts` — load/save/validate the pref.
