...
- [ ] A2 consumer-side token-purity ratchet test (blueprint apps)
- [ ] A5 reserved-namespace guard (`--c-*` etc.) in the same test
- [ ] A2 governance directive `no-hardcoded-colors`
