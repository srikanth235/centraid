...
| `Who this document names`, `Where it is` (properties) | No read on this seat returns the people a document mentions, and the drive projection carries no scope, so the panel cannot name the space or who can reach it. |
