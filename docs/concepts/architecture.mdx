...
2. **App** — a versioned folder of HTML/CSS/JS + handlers + a persistent SQLite database. Uploaded as a tarball; activated by atomically flipping `current.json#activeVersion`. [Read more →](/concepts/apps)
