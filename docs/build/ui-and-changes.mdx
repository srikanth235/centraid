...
See [`packages/app-templates/hydrate/index.html`](https://github.com/srikanthsrungarapu/secret/centraid/blob/main/packages/app-templates/hydrate/index.html) for the full bridge.
