...
> **TODO(#120)** — confirm the exact set of confirmation tokens recognized. The Hydrate template uses `"none"`; other templates may use other values. Worth a sweep of `packages/app-blueprints/*/app.json`.
