...
The app has one query and one action. Lifted from [`packages/app-templates/hydrate/queries/get-today.js`](https://github.com/srikanthsrungarapu/centraid/blob/main/packages/app-templates/hydrate/queries/get-today.js):
...
And [`packages/app-templates/hydrate/actions/set-cups.js`](https://github.com/srikanthsrungarapu/centraid/blob/main/packages/app-templates/hydrate/actions/set-cups.js):
