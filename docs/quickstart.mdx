...
The app has one query and one action. Lifted from [`packages/blueprints/hydrate/queries/get-today.js`](https://github.com/srikanthsrungarapu/centraid/blob/main/packages/blueprints/hydrate/queries/get-today.js):
...
And [`packages/blueprints/hydrate/actions/set-cups.js`](https://github.com/srikanthsrungarapu/centraid/blob/main/packages/blueprints/hydrate/actions/set-cups.js):
