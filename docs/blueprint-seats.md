...
1. **`ctx.delegate`** through the ACP harness registry (`packages/app-engine`) — a coding-agent harness turn, dispatcher-gated per call for provider egress (#567).
