---
summary: "Automations are app-owned projects that fire on a trigger instead of a UI click. Each is a directory with a manifest and a generated handler. A 'standalone' automation is just an app with no UI."
title: 'Overview'
---
