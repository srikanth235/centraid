...
From [`packages/app-blueprints/auto.briefing/automations/briefing/automation.json`](https://github.com/srikanthsrungarapu/centraid/blob/main/packages/app-blueprints/auto.briefing/automations/briefing/automation.json):
