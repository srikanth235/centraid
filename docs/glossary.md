...
| "placement_intents" for the sharing table | **`share_edges`** for same-owner add/move placements; `share_grant` for what a member shares with another person (#825), `share_circle_grant` for commons |
